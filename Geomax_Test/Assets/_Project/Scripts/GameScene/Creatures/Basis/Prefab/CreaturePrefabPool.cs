...
namespace _Project.Scripts.GameScene.Creatures.Basis.Prefab
{
    ...
    public class CreaturePrefabPool : ICreaturePrefabPool
    {
        ...
        private Dictionary<string, IZenjectFactoryMonoPool<CreaturePrefab>> _pools;
        ...
        private void CreatePool(string id)
        {
            ...
            var pool = new ZenjectFactoryMonoPool<CreaturePrefab>(prefab, _creaturePrefabFactory, container);
            _pools[id] = pool;
        }
    }
}